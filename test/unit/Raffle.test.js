    ...
    : describe("Raffle Unit Tests", function () {
          ...
          describe("enterRaffle", function () {
              ...
              it("doesn't allow entrance when raffle is calculating", async function () {
                  ...
                  await network.provider.send("evm_mine", []) // mine extra 1 block
          ...
          describe("checkUpkeep", function () {
              ...
              it("returns true if enought time passed, , eth, and is open", async function () {
                  await raffle.enterRaffle({ value: raffleEntranceFee })
                  await network.provider.send("evm_increaseTime", [interval.toNumber() + 1])
                  await network.provider.send("evm_mine", [])
                  const { upkeepNeeded } = await raffle.callStatic.checkUpkeep([])
                  ...
                  await new Promise(async (resolve, reject) => {
                      raffle.once("WinnerPicked", async function () {
                          ...
                          try {
                              ...
                              const numPlaysers = await raffle.getNumberOfPlayers()
                              const winnerEndingBalance = await accounts[1].getBalance()
                              assert.equal(numPlaysers.toString(), "0")
                              assert.equal(raffleState.toString(), "0")
                      ...
                      //   console.log("0 args: ", txnReceipt.events[0].args)
                      //   console.log("1 args: ", txnReceipt.events[1].args)
